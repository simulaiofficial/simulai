...
block_text = BlockText(id='1', type=BlockType.Text, details=Details(value='*Hi* my name is **simulai**. Well, actually I am a bot, which you can build by yourself, using our service https://www.simulai.co to build your **conversational form**'), isHidden=False)
block_heading = BlockHeading(id='2', type=BlockType.H1, details=Details(value='So I am a kind of "**Conversation Form**"'), isHidden=False)
block_divider = BlockDivider(id='3', type=BlockType.Divider, details=Details(), isHidden=False)
block_quote = BlockQuote(id='4', type=BlockType.Quote, details=Details(value='"**Conversational Form**" is a type of a web form which is used to chat with users to gather some data from them'), isHidden=False)
block_text1 = BlockText(id='text1', type=BlockType.Text, details=Details(value='Do you think that by conversation like that with a bot people may have easier time to share info about themselves?'), isHidden=False)
block_radio = BlockRadio(id='6', type=BlockType.Radio, details=Details(), isHidden=False, isRequired=False, setName=True, name='Radio Block', items=[OptionItem(label='Yes', isChecked=False), OptionItem(label='No', isChecked=True)])
block_text2 = BlockText(id='text2', type=BlockType.Text, details=Details(value='What type of form you used in the past?'), isHidden=False)
block_options = BlockOptions(id='5', type=BlockType.Options, details=Details(), isHidden=False, isRequired=True, setName=False, name='Options Block', items=[OptionItem(label='Web Form', isChecked=False), OptionItem(label='Conversational Form', isChecked=True)])
...
block_text5 = BlockText(id='text5', type=BlockType.Text, details=Details(value='could you share also your phone number?'), isHidden=False)
...
block_text_finish = BlockText(id='10', type=BlockType.Text, details=Details(value='That\'s all, thanks!'), isHidden=False)
...
sample_page = Page(
    ...
    blocks=[
        ...
        block_radio, block_text2, block_options, block_condition, block_text3, block_input_text, block_text4, block_input_email, block_text5, block_input_number, block_text_finish
    ]
)
